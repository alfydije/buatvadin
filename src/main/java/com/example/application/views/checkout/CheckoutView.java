...
public class CheckoutView extends Div implements BeforeEnterObserver {
    ...
    public CheckoutView(CheckoutService checkoutService) {
        ...
        LitRenderer<Checkout> gambarRenderer = LitRenderer
                .<Checkout>of("<img style='height: 64px' src=${item.gambar} />").withProperty("gambar", item -> {
        ...
        grid.addColumn(gambarRenderer).setHeader("Gambar").setWidth("68px").setFlexGrow(0);
    ...
    private void createEditorLayout(SplitLayout splitLayout) {
        ...
        formLayout.add(nama, alamat, tanggal, gambarLabel, gambar, order_notes);
